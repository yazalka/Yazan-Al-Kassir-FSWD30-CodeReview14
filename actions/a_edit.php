        ...
        <header id="header">
          ...
          <h3>Vienna</h3>
            ...
            <div class="box container-fluid text-center">
                <h1>Event has been Succcessfully Edited.</h1>
                <a href='../events.php'><button type='button'>Home</button></a>
                <a href='../edit.php?id=". $event_id ."'><button type='button'>Back</button></a>
            </div>
